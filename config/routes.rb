  ...
  namespace :api do
    ...
    resources :tasks, only: [ :show, :create, :update, :destroy ] do
      collection do
        ...
        update :update_state # update complete <-> incomplete
      end
    end
    ...
    # DASHBOARDS
    resources :dashboards, only: [ :show, :create, :update, :destroy ] do
      member do
        delete "members/:member_id", action: :delete_member # delete member
      end
    end

    resources :templates, only: [ :show, :create, :update, :destroy ] do
      collection do
        get "search"
      end
    end
